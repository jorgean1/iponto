...
story += [Spacer(1,28*mm), cover, Spacer(1,20*mm), Paragraph('Versão 1.0 - Setembro de 2026', ParagraphStyle('v',parent=styles['Smallx'],alignment=TA_CENTER)), PageBreak()]
...
data=[[Paragraph('<b>Horário</b>',styles['Bodyx']),Paragraph('<b>Ação</b>',styles['Bodyx'])],['Entrada','Escolhe aleatoriamente uma atividade visível e clica em Iniciar'],['Saída para almoço','Clica no controle Parar da atividade atual'],['Retorno do almoço','Escolhe aleatoriamente uma atividade visível e clica em Iniciar'],['Saída','Clica no controle Parar da atividade atual']]
...
story += [PageBreak(), Paragraph('3. Configuração inicial', styles['H1x']), step(1,'Horários','Informe entrada, saída para almoço, retorno do almoço e saída.'), step(2,'Acesso','Informe usuário e senha do Controle de Projetos. Confirme a URL /Lancamentos.'), step(3,'Atividades','Há um código opcional para a 1ª entrada e outro para a 2ª entrada (retorno). Se o código correspondente estiver preenchido, ele será usado sem sorteio. Se estiver vazio, uma das atividades recentes será sorteada.'), step(4,'E-mail','Informe destinatário, remetente, servidor, porta, usuário e senha SMTP.'), step(5,'Ative e salve','Marque Automação ativa e clique em Salvar configuração.')]
