...
story += [Spacer(1,28*mm), cover, Spacer(1,20*mm), Paragraph('Versão 1.3 - Setembro de 2026', ParagraphStyle('v',parent=styles['Smallx'],alignment=TA_CENTER)), PageBreak()]
