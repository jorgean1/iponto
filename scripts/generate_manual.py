...
story += [PageBreak(), Paragraph('3. Configuração inicial', styles['H1x']), step(1,'Horários','Informe entrada, saída para almoço, retorno do almoço e saída.'), step(2,'Acesso','Informe usuário e senha do Controle de Projetos. Confirme a URL /Lancamentos.'), step(3,'Atividades','Opcionalmente informe códigos separados por vírgula. Quando houver várias opções Iniciar visíveis, uma delas será escolhida aleatoriamente.'), step(4,'E-mail','Informe destinatário, remetente, servidor, porta, usuário e senha SMTP.'), step(5,'Ative e salve','Marque Automação ativa e clique em Salvar configuração.')]
